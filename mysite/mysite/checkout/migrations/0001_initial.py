# Generated by Django 3.2.2 on 2021-05-26 16:44
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('variant', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='variants', to='product.productvariant')),
            ],
        ),
    ]
